...
public class ActiveListItemAdapter extends FirebaseListAdapter<ShoppingListItem> {
     ...
     * (list_view_friends_autocomplete) with items inflated from single_active_list_item.xml
 ...
 */
        ...
        TextView textViewListItemName = (TextView) view.findViewById(R.id.text_view_active_list_item_name);


        /* Set the list name and owner */
        textViewListItemName.setText(item.getItemName());
